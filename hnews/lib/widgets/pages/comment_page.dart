...
import 'package:hnews/models/item.dart';
import 'package:hnews/repositories/hacker_news_repository.dart';
import 'package:hnews/widgets/headers/header.dart';
import 'package:hnews/widgets/rows/comment_row.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CupertinoNavigationBar(
          actionsForegroundColor: Colors.redAccent[400],
          middle: Text("Comments (${widget.item.descendants})")),
      body: (widget.item.kids.length == 0)
          ? ListView(
              children: <Widget>[
